...
# Version 0.1 on 4/20/2018 by Michael Whitis mdwhitis@gmail.com

rm no-key.log
aws iam get-group --group-name authorized-ssh-users  | grep UserName | cut -d\" -f4 |
while IFS= read -r username
do
aws  iam get-ssh-public-key --ssh-public-key-id APKAIVF7HHFX7VVWKVJQ --user-name "$username" --encoding SSH
if [ $? -ne 0 ]
